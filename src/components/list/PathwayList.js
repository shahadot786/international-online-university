  ...
  return (
    <View style={styles.container}>
      <View style={styles.list}>
        <Icon name="list-outline" size={24} color="#2B2B2B" />
        <Text style={styles.text}>240+ Categories to Choose From</Text>
      </View>
      <View style={styles.list}>
        <Icon name="people-outline" size={24} color="#2B2B2B" />
        <Text style={styles.text}>Expert Instruction</Text>
      </View>
      <View style={styles.list}>
        <Icon name="key-outline" size={24} color="#2B2B2B" />
        <Text style={styles.text}>Unlimited Access</Text>
      </View>
      <View style={styles.list}>
        <Icon name="md-logo-usd" size={24} color="#2B2B2B" />
        <Text style={styles.text}>Comfortable Prices</Text>
      </View>
      <View style={styles.list}>
        <Icon name="timer-outline" size={24} color="#2B2B2B" />
        <Text style={styles.text}>Free 15 Days Trail</Text>
      </View>
      <View style={styles.list}>
        <Feather name="loader" size={24} color="#2B2B2B" />
